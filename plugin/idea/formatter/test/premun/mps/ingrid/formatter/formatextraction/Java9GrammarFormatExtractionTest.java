    ...
    public void simpleAnimalClass() {
        ...
        verifyFormatInfo(
                ...
                rules(
                        ...
                        rule("unannInterfaceType", 0,
                                handle(
                                        element("unannClassType", newLine(false), space(true))
                                )
                        ),
                        ...
                        rule("primaryNoNewArray", 0,
                                handle(
                                        element("literal", newLine(false), space(true))
                                )
                        ),
                        rule("primaryNoNewArray", 1,
                                handle(
                                        element("classLiteral", newLine(false), space(true))
                                )
                        ),
                        rule("primaryNoNewArray", 2,
                                handle(
                                        element("this", newLine(false), space(true))
                                )
                        ),
                        rule("primaryNoNewArray", 5,
                                handle(
                                        element("classInstanceCreationExpression", newLine(false), space(true))
                                )
                        ),
                        rule("primaryNoNewArray", 6,
                                handle(
                                        element("fieldAccess", newLine(false), space(true))
                                )
                        ),
                        rule("primaryNoNewArray", 7,
                                handle(
                                        element("arrayAccess", newLine(false), space(true))
                                )
                        ),
                        rule("primaryNoNewArray", 8,
                                handle(
                                        element("methodInvocation", newLine(false), space(true))
                                )
                        ),
                        rule("primaryNoNewArray", 9,
                                handle(
                        ...
                        rule("classLiteral_block_1_1", 0,
                                handle(
                                        element("typeName", newLine(false), space(true))
                                )
                        ),
                        rule("classLiteral_block_1_1", 1,
                                handle(
                                        element("numericType", newLine(false), space(true))
                                )
                        ),
                        rule("classLiteral_block_1_1", 2,
                                handle(
                                        element("boolean", newLine(false), space(true))
                                )
                        ),
